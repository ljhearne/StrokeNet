function [fibers,streamIDX,lesionsize] = lesion_connectome(fibers,path2lesionfile,map_lesion)
%lesion_connectome
...
disp('... nearest neighbour search completed');
...
if map_lesion == 1
    ...
    disp('... fibers lesioned');
elseif map_lesion ==2
    fibers = fibers(idx,:);
    streamIDX = unique(fibers(:,4));
    disp('... ONLY lesion fibers included');
end
