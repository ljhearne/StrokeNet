function tract = mat2tract(fibers,chunkSize,tempDir,outfile)
% tract = mat2tract(fibers,streamIDX,chunkSize,tempDir,outfile)this
% function takes our newly defined fibers and converts them
    ...
    streamIDX = unique(fibers(:,4));
    
    if length(streamIDX) < 10000 % in the case of minimal fibers
        chunkSize = 50;
